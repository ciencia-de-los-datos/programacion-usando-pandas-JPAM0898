...
def pregunta_05():
    ...
    _c1 = tbl0['_c1'] 
    _c2 = tbl0['_c2'] 
    r = _c2.groupby(_c1).max()
    return r

def pregunta_06():
    """
    Retorne una lista con los valores unicos de la columna _c4 de del archivo `tbl1.csv` en mayusculas y ordenados alfabéticamente.
...
def pregunta_08():
    ...
    return tbl0.assign(suma = _c0 + _c2)
...
def pregunta_09():
    ...
    """
    _c3 = tbl0['_c3']
    return tbl0.assign(year = _c3.str[0:4])
...
def pregunta_11():
    ...
    _c0 = tbl1['_c0']
    _c4 = tbl1['_c4']
    r = _c4.groupby(_c0).apply(lambda x: ','.join(sorted(x))).reset_index(name='_c4')
    return r
